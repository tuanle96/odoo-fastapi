...
class FastapiEndpoint(models.Model):
    ...
    def _get_app_exception_handlers(
        ...
        return {
            ...
            RequestValidationError: error_handlers._odoo_request_validation_error_handler,
        }
    ...
    def _get_fastapi_app_dependencies(self) -> List[Depends]:
        ...
        return [Depends(dependencies.accept_language), Depends(dependencies.x_timezone)]
